_6b6‍.x([["messageSMS",()=>messageSMS],["messageTwitter",()=>messageTwitter],["emailSend",()=>emailSend],["getTwitterID",()=>getTwitterID]]);const nodeInstagram = require('node-instagram');
...
// });
       ...
       async function messageSMS(message, recipient){
    nexmo.message.sendSms(credentials.sms.sender,recipient, message,(err, responseData) => {
       ...
       function messageTwitter(message, recipient){
    getTwitterID(recipient, id=> {
       ...
       async function emailSend(message, recipient){
...
// }
       ...
       function getTwitterID(rec,callback) {
